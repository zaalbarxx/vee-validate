...
You can use yup as a typed schema with the `@zaalbarxx/vee-validate-yup` package:
...
You can use valibot as a typed schema with the `@zaalbarxx/vee-validate-valibot` package:

```sh
# npm
npm install @zaalbarxx/vee-validate-valibot
# yarn
