...
VeeValidate offers a wide range of common validators that you can use as global validators, they are packed in a separate package under the `@zaalbarxx/vee-validate-rules` namespace
...
```js
import { defineRule } from 'vee-validate';
import * as AllRules from '@zaalbarxx/vee-validate-rules';
